...
```{r}
p1 <- ggplot(merged_data, aes(x=End_of_Week, y=positiveIncreaseRate, colour = name)) +
  geom_line()
...
This model has a higher $R2$ than the linear regression model, at 0.336. Adding independent variables to a simple linear model improves the $R2$ and consequently the model's performance.
